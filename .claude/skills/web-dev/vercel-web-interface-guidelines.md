<!--
  VENDORED VERBATIM — do not edit the body below.

  Source:  https://github.com/vercel-labs/web-interface-guidelines  (AGENTS.md)
  Fetched: 2026-09-04
  Licence: MIT, Copyright (c) 2025 Vercel Labs

  Published by Vercel Labs specifically to be dropped into agent context.
  To update: re-fetch AGENTS.md from that repo and replace everything under this header.

  This is the BASELINE for interaction, forms, animation, performance and theming.
  GUIDELINES.md in this directory is the layer on top: composition, hierarchy,
  spacing/type rhythm, and the landing-page failure modes. Read both.
-->
