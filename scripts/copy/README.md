...
| `AT-n-nn` | workshop *n*, field *nn* (01 title … 11 body, 12 tags). *n* is **pinned per workshop** in `AT_ID`, not the site's 01–10 position — A8 arrived on 14 Sep and took site slot 07, and renumbering would have made `AT-7` mean a different workshop than in the document already returned. |
