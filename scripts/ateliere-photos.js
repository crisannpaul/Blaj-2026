 ...
 * and the seventh snaps into a sharp photograph reads as a bug.
 *
 * EMPTY, and that is the point: A7 was the last one on a stock frame and its
 * thumbnail was generated on 8 Sep. Kept as the mechanism, not as a leftover
 * entry — a slug listed here that also has a file in poze-org would be dead
 * config, since poze-org wins and nothing would say so.
 */
const STOCK = [];
